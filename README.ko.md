...
tokenmeter league match start --minutes 60   # 호스트: 1시간 경기(출력 토큰)
tokenmeter league match                      # 순위(확정 전에는 잠정)
